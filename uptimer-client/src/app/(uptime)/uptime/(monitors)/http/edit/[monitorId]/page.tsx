          ...
          <div className='m-auto mt-4 w-[80%] border bg-lightGray p-6'>
            ...
            <MonitorItem
              ...
              className={clsx(
                'block w-full rounded-lg border border-black bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500',
                {
                  'bg-gray pointer-events-none opacity-5':
            ...
            <div className='mt-5'>
              ...
              <select
                ...
                name='auth'
                className={clsx(
                  'block w-full rounded-md border border-black bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500',
                  {
